# MemGames Milestone 3
# Memory Palace Game v1

Write-Host "Creating Memory Palace feature..."

# Create folders

New-Item -ItemType Directory -Force -Path "app\games\memory"
New-Item -ItemType Directory -Force -Path "components"


# Create Memory game page
...
Write-Host "Memory Palace feature created."